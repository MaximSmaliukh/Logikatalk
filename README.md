...
- Required library: `threading.py` and `customtkinter.py` 
...
1. Run the script:
   ...
   python main.py
   ```
2. A window will display the chat.
3. Click the cross to exit .
...
## 🛠️ How It Works
1. You type in the bar and send it by the arrow
2. If someone is in the chat , he will get the message and you can get his/her messages
